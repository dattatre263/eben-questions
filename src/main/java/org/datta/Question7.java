 ...
 *
 * For this Question, I will not answer programatically because I am assuming you
 * do not want an algorith implementation using quees and trees. Several are available
 * in the internet.
 *
 * BSF or Breadth First Search is an algorithm used when you have to search through a
 * tree of nodes and you feel the solution is easy to find and not far from the root.
 *
 * Say for example you as the CTO is looking for number of projects in stash for company A then
 * you can follow the following steps
 *
 * a) ask VP of development ( Doug Miller) - No answer then
 * b) ask VP of Run ( Rob Crossley)  No answer the
 * c) ask Architects ..no answer ( you should probably get an answer by now)
 * d) ask Principal Engineers...
 *
 *
 * DFS or Depth first Search is an algorithm when you know the answers are few and
 * the possibility of the answer is deep within the graph.
 *
